...
void write_vga_desktop_system_font(void) {
    ...
    show_font8(vram, xsize, 8, 8, COL8_FFFFFF, system_font + 'A' * 16);
    show_font8(vram, xsize, 16, 8, COL8_FFFFFF, system_font + 'B' * 16);
    show_font8(vram, xsize, 24, 8, COL8_FFFFFF, system_font + 'C' * 16);
    show_font8(vram, xsize, 32, 8, COL8_FFFFFF, system_font + '1' * 16);
    show_font8(vram, xsize, 48, 8, COL8_FFFFFF, system_font + '2' * 16);
    show_font8(vram, xsize, 64, 8, COL8_FFFFFF, system_font + '3' * 16);
